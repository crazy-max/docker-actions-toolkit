...
class ImageTools {
    ...
    inspectManifest(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const cmd = yield this.getInspectCommand([name, '--format', '{{json .Manifest}}']);
            return yield exec_1.Exec.getExecOutput(cmd.command, cmd.args, {
                ignoreReturnCode: true,
                silent: true
            }).then(res => {
    ...
    attestationDescriptors(name) {
        return __awaiter(this, void 0, void 0, function* () {
            const manifest = yield this.inspectManifest(name);
    ...
    attestationDigests(name) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.attestationDescriptors(name)).map(attestation => attestation.digest);
        });
    }
}
