    ...
    static writeBuildSummary(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sum = core.summary
                ...
                .addRaw('</p>')
                .addRaw(`<p>`)
                .addRaw(`:arrow_down: ${addLink(`<strong>${util_2.Util.stringToUnicodeEntities(opts.uploadRes.filename)}</strong>`, artifactRelativeURL)} (${util_2.Util.formatFileSize(opts.uploadRes.size)})`)
                .addBreak()
            ...
            if (summaryError) {
                ...
                if (util_2.Util.countLines(summaryError) > 10) {
                    // prettier-ignore
                    sum
                        .addRaw(`<details ${util_2.Util.countLines(summaryError) <= 10 ? ' open' : ''}><summary><strong>Error</strong></summary>`)
                        .addCodeBlock(he_1.default.encode(summaryError), 'text')
                        .addRaw(`</details>`);
                }
                else {
                    // prettier-ignore
